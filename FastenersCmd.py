...
FSScrewCommandTable = {
    ...
    "DIN6330": (translate("FastenerCmd", "DIN 6330 Hexagon nuts with a height of 1,5 d"), NutGroup, NutParameters),
    ...
    "DIN6340": (translate("FastenerCmd", "DIN6340 Washers for clamping devices"), WasherGroup, WasherParameters),
